               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="规模" prop="qiyeGuimo">
                       <el-input v-model="ruleForm.qiyeGuimo"
                                 placeholder="规模" clearable  :readonly="ro.qiyeGuimo"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.qiyeChenglishijianTime"  class="input" label="企业成立时间" prop="qiyeChenglishijianTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.qiyeChenglishijianTime"
                                type="datetime"
                                placeholder="企业成立时间"
                                :disabled="ro.qiyeChenglishijianTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qiyeChenglishijianTime" label="企业成立时间" prop="qiyeChenglishijianTime">
                            <span v-html="ruleForm.qiyeChenglishijianTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
