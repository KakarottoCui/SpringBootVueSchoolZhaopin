        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="用户状态" prop="yonghuZhuangtaiTypes">
                        <el-select v-model="ruleForm.yonghuZhuangtaiTypes" :disabled="ro.yonghuZhuangtaiTypes" placeholder="请选择用户状态">
                            <el-option
