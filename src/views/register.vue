    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                qiyePhotoFlag:false,//用于刷新文件上传
                xuexiaorenyuanPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            qiyePhotoUploadChange(fileUrls) {
               this.ruleForm.qiyePhoto = fileUrls;
                if(this.qiyePhotoFlag){
                    this.qiyePhotoFlag=false;
                }else{
                    this.qiyePhotoFlag=true;
                }
            },
            xuexiaorenyuanPhotoUploadChange(fileUrls) {
               this.ruleForm.xuexiaorenyuanPhoto = fileUrls;
                if(this.xuexiaorenyuanPhotoFlag){
                    this.xuexiaorenyuanPhotoFlag=false;
                }else{
                    this.xuexiaorenyuanPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            // qiye 中的 企业类型 判空处理
                            // if('qiye' == this.tableName && (this.ruleForm.qiyeTypes== null ||this.ruleForm.qiyeTypes== "")){
                            ...
                            // qiye 中的 企业logo 判空处理
                            // if('qiye' == this.tableName && (this.ruleForm.qiyePhoto== null ||this.ruleForm.qiyePhoto== "")){
                            //     this.$message.error("企业logo不能为空");
                            //     return
                            // }
                            // qiye 中的 规模 判空处理
                            // if('qiye' == this.tableName && (this.ruleForm.qiyeGuimo== null ||this.ruleForm.qiyeGuimo== "")){
                            //     this.$message.error("规模不能为空");
                            //     return
                            // }
                            // qiye 中的 企业成立时间 判空处理
                            // if('qiye' == this.tableName && (this.ruleForm.qiyeChenglishijianTime== null ||this.ruleForm.qiyeChenglishijianTime== "")){
                            //     this.$message.error("企业成立时间不能为空");
                            //     return
                            // }
                            // qiye 中的 企业介绍 判空处理
                            // if('qiye' == this.tableName && (this.ruleForm.qiyeContent== null ||this.ruleForm.qiyeContent== "")){
                            //     this.$message.error("企业介绍不能为空");
                            //     return
                            // }
                            // qiye 中的 逻辑删除 判空处理
                            // if('qiye' == this.tableName && (this.ruleForm.qiyeDelete== null ||this.ruleForm.qiyeDelete== "")){
                            //     this.$message.error("逻辑删除不能为空");
                            //     return
                            // }
                            // qiye 中的 创建时间 show1 show2 photoShow 判空处理
                            // if('qiye' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            //     this.$message.error("创建时间 show1 show2 photoShow不能为空");
                            //     return
                            // }
                            if((!this.ruleForm.xuexiaorenyuanName)&& 'xuexiaorenyuan'==this.tableName){
                                this.$message.error('学校人员姓名不能为空');
                                return
                            }
                            // xuexiaorenyuan 中的 头像 判空处理
                            // if('xuexiaorenyuan' == this.tableName && (this.ruleForm.xuexiaorenyuanPhoto== null ||this.ruleForm.xuexiaorenyuanPhoto== "")){
                            //     this.$message.error("头像不能为空");
                            //     return
                            // }
                             if('xuexiaorenyuan' == this.tableName && this.ruleForm.xuexiaorenyuanPhone&&(!this.$validate.isMobile(this.ruleForm.xuexiaorenyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.xuexiaorenyuanIdNumber)&& 'xuexiaorenyuan'==this.tableName){
                                this.$message.error('学校人员身份证号不能为空');
                                return
                            }
                            if('xuexiaorenyuan' == this.tableName && this.ruleForm.xuexiaorenyuanEmail&&(!this.$validate.isEmail(this.ruleForm.xuexiaorenyuanEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // xuexiaorenyuan 中的 创建时间 判空处理
                            // if('xuexiaorenyuan' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            ...
                            // yonghu 中的 用户状态 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuZhuangtaiTypes== null ||this.ruleForm.yonghuZhuangtaiTypes== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/xiaoyuanzhaopin/img/back-img-bg.jpg);
